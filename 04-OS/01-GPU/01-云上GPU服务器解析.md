...
![image-20251221095238253](assets/image-20251221095238253.png)

直通

```
[root@test ~]# nvidia-smi
Sun Dec 21 10:04:35 2025       
+---------------------------------------------------------------------------------------+
...
![image-20251221100502016](assets/image-20251221100502016.png)





可以看到显卡位置，第一个是A10-4Q，第二个是A10，则表示第一个是半虚

- GPU 名称带后缀如 `-4Q`、`-2C` 等（云厂商自定义命名）

  半虚后边一般加了参数，表示被切分为了四个实例
